            ...
            <div className="app-section animate-fade-in">
              <div className="app-info">
                <div className="app-icon user-icon">
                  <img src="/assets/hand icon 1.png" alt="User App Icon" className="app-icon-image" width={1024} height={1024} decoding="async" />
                </div>
            ...
            <div className="app-section animate-fade-in">
              <div className="app-info">
                <div className="app-icon provider-icon">
                  <img src="/assets/blue on black.jpg" alt="Provider App Icon" className="app-icon-image" width={1024} height={1024} decoding="async" />
                </div>
