...
const DownloadModalContent = ({ isOpen, onClose, activeTab: initialActiveTab = 0 }) => {
            ...
            <div className="app-section animate-fade-in">
              <div className="app-info">
                <div className="app-icon provider-icon">
                  <img
                    src="/assets/blue on black.jpg"
                    alt="Provider App Icon"
                    className="app-icon-image"
                    width={1024}
                    height={1024}
                    decoding="async"
              ...
              <div className="download-section">
                ...
                <div className="store-section">
                  ...
                  <a
                    href={appLinks.provider.android}
                    className="download-btn android-btn"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
